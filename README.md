...
I wanted a project that wasn't just a to-do list clone — something with real auth, a real database, and a UI that has to actually communicate numbers clearly (monthly vs. yearly totals aren't as trivial to display well as they sound). It was also a good excuse to get hands-on with the newest Next.js and React versions instead of just reading the release notes.
