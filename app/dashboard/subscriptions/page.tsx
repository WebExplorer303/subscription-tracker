...
export default async function SubscriptionsPage() {
  ...
  return (
    <>
      ...
      <div className="overflow-x-auto rounded-lg border-b border-gray-200 dark:border-gray-700 shadow-sm">
        <table className="min-w-full divide-y divide-gray-300 bg-white dark:bg-gray-800">
          <thead>
            <tr>
            ...
            {subscriptions.map((sub: Subscription) => (
              <tr key={sub.id} className="hover:bg-gray-50 dark:hover:bg-gray-700">
                ...
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-white">
                  {sub.nextRenewal instanceof Date ? sub.nextRenewal.toLocaleDateString() : sub.nextRenewal}
                </td>
